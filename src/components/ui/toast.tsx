...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 ulxs:bottom-auto ulxs:right-0 ulxs:top-0 ulxs:flex-col vxs:bottom-auto vxs:right-0 vxs:top-0 vxs:flex-col xs:bottom-auto xs:right-0 xs:top-0 xs:flex-col sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
